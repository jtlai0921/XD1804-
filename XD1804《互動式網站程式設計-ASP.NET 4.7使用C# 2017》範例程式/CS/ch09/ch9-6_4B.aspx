<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ch9-6_4B.aspx.cs" Inherits="ch9_7_4" %>
...
<body>
            ...
            <asp:TemplateField HeaderText="性別" SortExpression="性別">
                <EditItemTemplate>
                    <asp:DropDownList ID="DropDownList1" runat="server" 
                        DataSourceID="AccessDataSource2" DataTextField="性別" DataValueField="性別" 
    ...
    <asp:AccessDataSource ID="AccessDataSource2" runat="server" 
        DataFile="~/App_Data/學生資料庫.mdb" 
        SelectCommand="SELECT DISTINCT [性別] FROM [學生成績表]"></asp:AccessDataSource>
