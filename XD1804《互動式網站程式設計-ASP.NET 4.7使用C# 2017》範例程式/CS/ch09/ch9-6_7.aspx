<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ch9-6_7.aspx.cs" Inherits="ch9_7_7" %>
...
<body>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        CellPadding="4" DataKeyNames="序號" DataSourceID="AccessDataSource1" 
        ...
        <Columns>
            ...
            <asp:ButtonField ButtonType="Button" CommandName="Sum" Text="總成績" />
        </Columns>
