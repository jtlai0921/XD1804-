<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ch10-1_3A.aspx.cs" Inherits="ch10_1_1" %>
...
<body>
    ...
    <asp:DropDownList ID="DropDownList1" runat="server" AppendDataBoundItems="True" 
        ...
        DataValueField="學號" onselectedindexchanged="DropDownList1_SelectedIndexChanged">
