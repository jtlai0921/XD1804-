<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ch10-2_1.aspx.cs" Inherits="ch10_1_1" %>
...
<body>
    ...
    <div>
        <asp:AccessDataSource ID="AccessDataSource1" runat="server" 
            ...
            InsertCommand="INSERT INTO [學生成績表] ([學號], [姓名], [性別], [資料庫成績], [系統分析成績], [程式設計成績], [計算機概論成績]) VALUES (?, ?, ?, ?, ?, ?, ?)" 
    ...
    <asp:DetailsView ID="DetailsView1" runat="server" AllowPaging="True" 
        ...
        <Fields>
            <asp:BoundField DataField="序號" HeaderText="序號" InsertVisible="False" 
                ReadOnly="True" SortExpression="序號" />
