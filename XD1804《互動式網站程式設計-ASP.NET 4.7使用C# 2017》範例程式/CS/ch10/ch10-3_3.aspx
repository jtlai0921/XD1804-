<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ch10-3_3.aspx.cs" Inherits="ch10_1_1" %>
...
<body>
    ...
    <table class="style1">
        ...
        <tr>
            ...
            <td class="style4">
                <asp:TextBox ID="TextBox2" runat="server" Width="98px"></asp:TextBox>
            </td>
            <td class="style3">
                <asp:Button ID="Button1" runat="server" onclick="Button1_Click" Text="加選課程" />
            </td>
        </tr>
    </table>
